   ...
   <div class="inner-wrapper"> 
    ...
    <section class="panel">
      <header class="panel-heading">    
        <div class="row">
          <div class="col-sm-3" align="left"><h2 class="panel-title">Tanah Sudah SHGB</h2></div>
          <form action="<?php echo site_url('Export_excel/laporan_rekap_evaluasi_sudah_shgb_per/') ?>" method="get">
        ...
        <table class="table table-bordered table-hover table-striped" id="itemsdata">
          <thead>
            <tr>
              ...
              <th rowspan="2" style="text-align: center;vertical-align: middle;">BATAS WAKTU SHGB</th>
