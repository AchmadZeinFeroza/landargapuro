          ...
          <section class="panel">
            <header class="panel-heading">    
                <div class="row show-grid">
                    ...
                    ?>
                <form action="<?php echo site_url('Export_excel/laporan_rekap_evaluasi_proses_splitsing/') ?>" method="get">
                    ...
                    <table class="table table-bordered table-hover table-striped data" id="itemsdata">
                        <thead>
                            <tr>
                                ...
                                <th  colspan="3" style="text-align: center;vertical-align: middle;">PROSES SPLITSING</th>
                                <th colspan="12" style="text-align: center;vertical-align: middle;">TERBIT TAHUN 2020</th>
                                <th rowspan="2" style="text-align: center;vertical-align: middle;">SISA BELUM TERBIT</th>
                            ...
                            <tr>
                                <th  style="text-align: center;vertical-align: middle;">sd 2019</th>
