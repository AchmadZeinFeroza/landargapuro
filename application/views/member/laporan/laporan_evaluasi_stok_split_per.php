  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <section class="panel  panel-primary">
        ...
        <header class="panel-heading">
          <h2 class="panel-title">Split Kavling</h2>
        </header>
        <div class="panel-body">
          <div class="form-group mt-lg blok">
            <label class="col-sm-3 control-label">Nama Blok<span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" disabled='disabled' name="blok" id="blok" class="form-control" required/>
            </div>
          </div>  
          <div class="form-group mt-lg luas_teknik">
            <label class="col-sm-3 control-label">Luas Teknik<span class="required">*</span></label>
...
<div class="modal fade" id="splitData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <section class="panel  panel-primary">
        <?php echo form_open('master/stok_splitedit',' id="FormulirEdit"');?>  
        ...
        <div class="panel-body">
          ...
          <div class="form-group mt-lg luas_teknik">
            <label class="col-sm-3 control-label">Luas Daftar<span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" name="luas_daftar" id="luas_teknik" class="form-control" required/>
            </div>
          </div>  
        </div>
        <footer class="panel-footer">
...
if(level_user('tools','import_item',$this->session->userdata('kategori'),'add') > 0){
  ...
  document.getElementById("FormulirSplit").addEventListener("submit", function (e) {  
   blurForm();       
   $('.help-block').hide();
   $('.form-group').removeClass('has-error');
