        ...
        <table class="table table-bordered table-hover table-striped data" id="itemsdata">
            <thead>
                <tr>
                    ...
                    <th colspan="7" style="text-align: center;vertical-align: middle;">PENGALIHAN HAK</th>
                    <th rowspan="2" style="text-align: center;vertical-align: middle;">S TERIMA FINANCE</th>
                    <th rowspan="2" style="text-align: center;vertical-align: middle;">S SHGB</th>
            ...
            <tbody>
                ...
                if ($dataperumahanseb!=''): 
                    ...
                    foreach ($dataperumahanseb as $value => $data):?>
                       <tr>
                         <?php 
                         $tomboledit = level_user('master','items',$this->session->userdata('kategori'),'edit') > 0 ? '<li><a href="#" onclick="edit(this)" data-id="'.$this->security->xss_clean($data->kode_item).'">Ubah Status</a></li>':'';
                         $tombol='
