          ...
          <section class="panel">
            <header class="panel-heading">    
                <div class="row show-grid">
                    ...
                    ?> 
                    <form action="<?php echo site_url('Export_excel/laporan_rekap_evaluasi_sudah_shgb/') ?>" method="get">
                ...
                <div class="form-group mt-lg nama_target">
                    ...
                    <div class="col-sm-9">
                        <select data-plugin-selectTwo class="form-control" required id="id_perumahan" name="id_perumahan">  
                            <option value="">Pilih Lokasi</option>
                            <?php foreach ($perumahan as $supp): ?>
                                <option value="<?php echo $supp->id;?>"><?php echo $aa->nama_regional;?> ( <?php echo $supp->nama_status;?> )</option>
                            <?php endforeach; ?>
                        </select> 
                    </div>
                </div>
