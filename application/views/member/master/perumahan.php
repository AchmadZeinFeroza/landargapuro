      ...
      <section class="panel  panel-primary">
        ...
        <div class="panel-body">
          ...
          <div class="form-group mt-lg nama_target">
            <label class="col-sm-3 control-label">Status<span class="required">*</span></label>
            <div class="col-sm-9">
              <select data-plugin-selectTwo class="form-control" required id="status_regional_edit" name="status_regional">  
                <option value="">Pilih Status</option>
                <?php foreach ($status as $supp): ?>
                  <option value="<?php echo $supp->id_status_regional;?>"><?php echo $supp->nama_status;?></option>
                <?php endforeach; ?>
      ...
      success: function(response) {  
        ...
        $.each(response, function(i, item) { 
          ...
          document.getElementById("nama_regional").setAttribute('value', item.nama_regional);
                ...
                $("#status_regional_edit").val(item.status_regional);
                $("#kabupatenedit").val(item.id_kabupaten);
                $("#kecamatanedit").html(new Option(item.nama_kecamatan, item.id_kecamatan));  
                $("#lokasi").html(new Option(item.nama_desa, item.lokasi));   
              }); 
      }
    });  
    return false;
