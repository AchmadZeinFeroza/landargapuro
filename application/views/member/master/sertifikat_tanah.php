          ...
          <section class="panel">
            <header class="panel-heading">    
                <div class="row show-grid">
                    <div class="col-md-6" align="left"><h2 class="panel-title">Data Sertifikat Tanah</h2></div>
                    <?php  
...
<div class="modal fade" data-keyboard="false" data-backdrop="static"  id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <section class="panel panel-primary">
                <?php echo form_open('master/sertifikat_tanahedit',' id="FormulirEdit"');?>  
                ...
                <div class="panel-body">
                    <div class="form-group mt-lg kode_sertifikat">
                        <label class="col-sm-3 control-label">Kode Sertifikat<span class="required">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="kode_sertifikat" id="kode_sertifikat" class="form-control" required/>
                        </div>
                    </div> 
                    <div class="form-group mt-lg nama_sertifikat">
                        <label class="col-sm-3 control-label">Nama Sertifikat<span class="required">*</span></label>
        ...
        <div class="modal-content">
            <section class="panel  panel-danger">
                ...
                <footer class="panel-footer"> 
                    <div class="row">
                        <div class="col-md-12 text-right"> 
                            <?php echo form_open('master/sertifikat_tanahhapus',' id="FormulirHapus"');?>  
...
<script type="text/javascript"> 
    var tablesertifikat_tanah = $('#sertifikat_tanahdata').DataTable({  
        ...
        "order": [], 
        "ajax": {
            "url": "<?php echo base_url()?>master/datasertifikat_tanah",
            "type": "GET"
        }, 
        "columnDefs": [
        { 
    ...
    function edit(elem){
      ...
      $.ajax({
        type: 'GET',
        url: '<?php echo base_url()?>master/sertifikat_tanahdetail',
        data: 'id=' + dataId,
        dataType 	: 'json',
        success: function(response) {  
            $.each(response, function(i, item) { 
                document.getElementById("kode_sertifikat").setAttribute('value', item.kode_sertifikat); 
                document.getElementById("nama_sertifikat").setAttribute('value', item.nama_sertifikat); 
            }); 
        }
    });  
      return false;
